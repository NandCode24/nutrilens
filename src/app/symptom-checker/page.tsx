...
import ApiLoader from "@/components/ApiLoader"; // 🌀 overlay loader
...
export default function SymptomChecker() {
  ...
  const { showLoader, hideLoader } = useLoading(); // for routing loader only

  // 🧠 Handle symptom submission (API)
  ...
  return (
    <>
      {apiLoading && <ApiLoader />} {/* 🧩 overlay loader active during API */}
      <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
        {/* ✅ Back button (fixed: no nested buttons) */}
        <div
